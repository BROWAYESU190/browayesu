        ...
        sock.ev.on("connection.update", async (update) => {
            ...
            if (connection === "open") {
                ...
                try {
                    ...
                    const sessionId = "BROWAYESU-MD~" + base64;

                    await sock.sendMessage(sock.user.id, { text: sessionId });

                    const successMsg = {
                        text:
                            `🚀 *BROWAYESU-MD Session Created!*\n\n` +
                            `▸ *Never share* your session ID\n` +
                            `▸ Join our WhatsApp Channel\n` +
                            `▸ Report bugs on GitHub\n\n` +
                            `_Powered by ARSLAN-MD\n\n` +
                            `🔗 *Useful Links:*\n` +
                            `▸ GitHub: https://github.com/BroWaYesu/BROWAYESU-MD\n` +
                        ...
                        contextInfo: {
                            ...
                            forwardedNewsletterMessageInfo: {
                                newsletterJid: "0029Vb6YML80VycDvHq6yV3S@newsletter",
                                newsletterName: "BROWAYESU-MD",
                                serverMessageId: 143
                            }
                        }
                    };
